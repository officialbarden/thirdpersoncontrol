...
#> W
execute if predicate speclib:input/w unless predicate speclib:input/sprint run summon marker ^ ^ ^-0.3 {Tags:["motion.temp"]}
...
#> WA
execute if predicate speclib:input/w if predicate speclib:input/a unless predicate speclib:input/sprint run summon marker ^-0.3 ^ ^-0.3 {Tags:["motion.temp"]}
...
#> WD
execute if predicate speclib:input/w if predicate speclib:input/d unless predicate speclib:input/sprint run summon marker ^0.3 ^ ^-0.3 {Tags:["motion.temp"]}
...
#> S
execute if predicate speclib:input/s unless predicate speclib:input/sprint run summon marker ^ ^ ^0.3 {Tags:["motion.temp"]}
...
#> SA
execute if predicate speclib:input/s if predicate speclib:input/a unless predicate speclib:input/sprint run summon marker ^-0.3 ^ ^0.3 {Tags:["motion.temp"]}
...
#> SD
execute if predicate speclib:input/s if predicate speclib:input/d unless predicate speclib:input/sprint run summon marker ^0.3 ^ ^0.3 {Tags:["motion.temp"]}
...
#> A
#execute if predicate speclib:input/a unless predicate speclib:input/sprint run summon marker ^-0.3 ^ ^ {Tags:["motion.temp"]}
...
#> D
#execute if predicate speclib:input/d unless predicate speclib:input/sprint run summon marker ^0.3 ^ ^ {Tags:["motion.temp"]}
